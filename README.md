...
这是一个用于 Minecraft Paper 服务器的插件，添加了五件新物品："复生之锄"、"可再生石斧"、"引路之锹"、"寻觅之镰"和"百分比金剑"。
...
- **特殊效果**: 可以在下界生成湿润的耕地，且生成的耕地不会自动干涸。（防干涸默认开启，可在配置文件中关闭）
...
| 指令               | 权限   | 说明     | <br /> | <br />                | <br /> | <br />        |
| ---------------- | ---- | ------ | :----- | :-------------------- | :----- | :------------ |
| `/rh`            | 所有玩家 | 显示插件信息 | <br /> | <br />                | <br /> | <br />        |
| `/rh info`       | 所有玩家 | 显示插件信息 | <br /> | <br />                | <br /> | <br />        |
| `/rh reload`     | OP   | 重载插件   | <br /> | <br />                | <br /> | <br />        |
| `/rh give \<hoe \| axe  \| shovel \| scythe \| sword> \[玩家名] \[数量]\` | OP     | 获取物品（玩家和数量可选） |
